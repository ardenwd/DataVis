...
d3.csv('letter_freq.csv', dataPreprocessor).then(function(dataset) {
    ...
    dataset.forEach(function(d,i){
        ...
        chartG.append('g').call(bottomAxis)
         ...
         //creating bars from activty 1

        // var letter = chartG.append("text").attr('class','letter-label letter');
        // letter.attr("y",barBand*i).text(d.letter).attr('transform', 'translate(-20,12)');
        // var bar = chartG.append("rect").attr('class','bar');
        // bar
